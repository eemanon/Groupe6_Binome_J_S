...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 301, 301))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Carte", None))
        
        self.plainTextEdit.setToolTip("Entrez votre commande")
        self.pushButton.setToolTip("Envois de la commande")
        self.pushButton_2.setToolTip("Deplace le robot vers le haut")
        self.pushButton_3.setToolTip("Deplace le robot vers la gauche")
        self.pushButton_4.setToolTip("Deplace le robot vers le bas")
        self.pushButton_5.setToolTip("Deplace le robot vers la droite")
        self.radioButton.setToolTip("Pause")
